...
<div class="content-wrapper">
 ...
 action="<?php echo base_url().'admin/category/edit/'.$category['id']; ?>" method="post">
             ...
             <div class="card-body">
                ...
                <div class="form-group">
                    ...
                    <?php  } else {  ?>
                        ...
                        <img  class="mt-3" width="200px" height="200px" src="<?php echo base_url().'public/uploads/category/images.jpg'; ?>">
                    <?php } ?>
                </div>
                

                <div class="custom-control custom-radio float-left">
                    <input class="custom-control-input" value="1"  type="radio" name="status" id="statusActive" <?php echo ($category['status']==1) ? 'checked' : ''; ?>>
                    <label for="statusActive" class="custom-control-label">Active</label>
                   
                </div>
                <div class="custom-control custom-radio float-left ml-3">
                    <input class="custom-control-input" value="0"  type="radio" name="status" id="statusBlock" <?php echo ($category['status']==0) ? 'checked' : ''; ?> >
