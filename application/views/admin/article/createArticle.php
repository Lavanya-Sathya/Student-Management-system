        ...
        <div class="row">
          ...
          <?php if($this->session->flashdata('success')!="") {?>
            ...
            <div class="card-primary">
             ...
             <form id="categoryForm" name="categoryForm" enctype= "multipart/form-data" action="<?php echo base_url(); ?>admin/article/createArticle" method="post">
             ...
             <div class="card-body">
                    ...
                    <select name="category_id" id="category_id" class="form-control <?php echo  (form_error('category_id') !='') ? 'is-invalid' : ''; ?>">
                        ...
                        <?php  if(!empty($category)){
                             foreach($category as $categoryRow){ ?>
                                <option <?php echo set_select('category_id',$categoryRow['id'],false); ?> value="<?php echo $categoryRow['id']; ?>"><?php echo $categoryRow['name']; ?></option>
                         <?php }} ?>   
                    </select>
                ...
                <div class="form-group">
                    ...
                    <input type="text" value="<?php echo set_value('title'); ?>" class="form-control <?php echo (form_error('title') !='') ? 'is-invalid' : ''; ?>" name="title" id="title"  >
                    <?php echo form_error('title'); ?>
                </div>
                <div class="form-group">
                    <label for="name">Description</label>
                    <textarea name="description" id="description" class="textarea" value="<?php echo set_value('description'); ?>" ><?php echo set_value('description'); ?></textarea>
                ...
                <div class="form-group">
                    ...
                    <input type="text"  class="form-control <?php echo (form_error('author') !='') ? 'is-invalid' : ''; ?>" value="<?php echo set_value('author'); ?>" name="author" id="author" >
