    ...
    <div class="row mb-5">
        ...
        <div class="col-md-8">
            <p class="bg-light pt-2 pb-2 pl-3 ">
                <a href="<?php echo base_url().'event/category/'.$articleRow['category']; ?>" class="text-muted text-uppercase"><?php echo $articleRow['category_name']; ?></a>
            </p>
